...
class ConfirmDigitalForm1 extends Component<any, any> {
  ...
  mountprojectinfo = () => {
        ...
        row.push(
          <div>
            <HStack className="textdiv">
              ...
              <div className="projsecondpart">{val[key]}</div>
            </HStack>
          </div>
        );
      });
    ...
    this.setState({ rows: row }, () =>
      console.log("the row is ", this.state.dict)
    );
  };
...
export default withRouter(ConfirmDigitalForm1);
